...
def find_related_entry(description: str, db: Session) -> MerchantMap | None:
    ...
    filler words (e.g. "Zelle Payment To Jane Doe LLC" vs. the AI's suggested_key "zelle
    payment jane doe") and unique trailing reference numbers. Used when a user edits a
